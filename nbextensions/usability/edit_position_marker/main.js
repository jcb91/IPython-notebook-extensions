define([
	...
	var params = {
		...
		edit_position_history_set_marker_shortcut : 'ctrl-H',
		edit_position_history_goto_marker_shortcut : 'ctrl-G',
	...
	function goto_marker() {
		...
		for (var ii=0; ii< cells.length; ii++) {
			if (cell === cells[ii]) {
				...
				cell.code_mirror.setCursor(marker.bookmark.find());
				break;
			}
		}
		return true;
	...
	function load_jupyter_extension () {
		...
		// get all of the config.loaded.then stuff done
		config.load();
	}
